...
- Get LAB data --> 
  - finish up the saved labData file
  - show how to load that data
  - show how to merge that data
  - add similarity values 
- Get SPAML data --> 
  - list of stimuli (procedure folder)
  - matched data 
  - similarity values from stimuli (merge these together, procedure folder)
    - your similarity values 
    
    o	All averaged cosine: all cosine values in the same format/order as described above with the exception that repeated cue/target combinations were averaged together. 
    	Cue target with b., m., v. to determine which dataset the cue and target originated from. 
	Root cosine, raw cosine, affix cosine from this set of calculations
	Old cosine from Buchanan et al.
	JCN, LSA, FSG, BSG

    
    - https://github.com/AaltoImagingLanguage/SemanticNorms/tree/master
    - nelson norms
    - swow different languages
    - vivas 2016
    - kremer 2011
    - montefinese 2012
  - output data
    /Users/erinbuchanan/GitHub/Research/2_projects/PSA_Projects/SPAML/SPAML-PSA/05_Data/data_processing/output_data/full_data
/Users/erinbuchanan/GitHub/Research/2_projects/PSA_Projects/SPAML/SPAML-PSA/05_Data/data_processing/output_data/item_data
/Users/erinbuchanan/GitHub/Research/2_projects/PSA_Projects/SPAML/SPAML-PSA/05_Data/data_processing/output_data/participant_data
/Users/erinbuchanan/GitHub/Research/2_projects/PSA_Projects/SPAML/SPAML-PSA/05_Data/data_processing/output_data/priming_data
/Users/erinbuchanan/GitHub/Research/2_projects/PSA_Projects/SPAML/SPAML-PSA/05_Data/data_processing/output_data/trial_data
