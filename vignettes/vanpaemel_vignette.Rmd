...
```{r data read-in-temp, eval = F, echo = F}
### for typicality data -- cleaning and processing
typicality_fnames <- list.files(path = "vignettes/data/vanpaemel_data",
                                full.names = TRUE)
...
```{r eval = F, echo = F}
metadata <- import("vignettes/data/vanpaemel_metadata.xlsx")
